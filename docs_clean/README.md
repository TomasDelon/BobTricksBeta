...
- `docs_clean/` contiene la línea que deberá consolidarse y reescribirse de forma canónica cuando la estructura conceptual quede suficientemente estabilizada.
...
Documentos que requieren futura actualización o consolidación prioritaria:
...
- Usar `docs_clean/` como destino de consolidación futura cuando la notación, dependencias y estructura conceptual estén auditadas.
